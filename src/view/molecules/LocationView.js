...
import { LocationRainChart, LocationTempChart, CustomGuage } from "../../view/molecules";
...
const nDays32C = dataset.filter(d => d.tempMax > 32 ).length;
  ...
  return (
    ...
    <Stack spacing={2} direction="row" alignItems="center">
      <CustomGuage value={nDays1mm} valueMax={N_DISPLAY} label=">1mm" color="#08f" subLabel="Rain"/>
      <CustomGuage value={nDays25mm} valueMax={N_DISPLAY} label=">25mm" color="#04f" subLabel="Rain"/>   

            <CustomGuage value={nDays24C} valueMax={N_DISPLAY} label="<24°C" color="#080" subLabel="Min. Temp."/>   
      <CustomGuage value={nDays28C} valueMax={N_DISPLAY} label=">28°C" color="#c00" subLabel="Max. Temp."/>
      <CustomGuage value={nDays32C} valueMax={N_DISPLAY} label=">32°C" color="#800" subLabel="Max. Temp."/>
    </Stack>
